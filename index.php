...
<body>
   <?php include "Nav.php"?>
    ...
    <div class="home" id="Home">
        <div class="details">
            <h2>I'm <font color="red">Hancie </font>Phago</h2>
    ...
    <div class="container py-4 py-xl-5">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-6">
                <div class="p-xl-5 m-xl-5"><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="Images/Hancie-Phago.jpg"></div>
            </div>
            <div class="col-md-6 d-md-flex align-items-md-center">
                <div style="max-width: 350px;">
                    <h2 class="text-uppercase fw-bold">Hancie Phago</h2>
                    <p class="text-uppercase">Software Developer</p>
                    <p class="my-3">Hello! My name is Hancie Phago. I am a software developer and currently studying software engineering at PCPS College. Visit my website if you'd like to get in touch with me.</p><a class="btn btn-primary btn-lg me-2" role="button" href="https://hanciephago.com.np/">Website</a>
                </div>
            </div>
        </div>
    </div>
...
<div id="container" class="container-fluid  py-4 py-xl-5">
        <div class="row mb-5">
    ...
    <div class="contact" id="Contact">
        <div class="contact-heading"> You have any idea or suggestion contact us </div>
        <div class="contact-form">
            ...
            <div class="input-message"> <textarea placeholder="write message to us ..."></textarea> <button>Send Message</button> </div>
        </div>
    </div>
