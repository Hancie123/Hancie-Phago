...
<div class="w3-container">
  <h2 class="text-center">Room Deposit Details</h2>
...
include "connection.php";
$id=$_SESSION['id'];
$query=mysqli_query($conn, "SELECT * FROM room_expenses  WHERE User_ID='$id' AND Status='Deposit' GROUP BY Date2 ORDER BY Expenses_ID") or 
die(mysqli_error());
...
<tr>
  ...
  <td> Rs. <?php echo $fetch['Deposit'];?></td>
...
function generate() {
    ...
    var y = 20;
    doc.setLineWidth(2);
    doc.text(250, y = y + 30, "Money Deposit Report");
    doc.autoTable({
        html: '#hancie',
        startY: 70,
        theme: 'grid',
