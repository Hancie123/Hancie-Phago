...
<div class="text-center">
  <h2 id="heading" class="p-0 m-0 text-light p-3 bg-success">Saving Amounts</h2>
</div>
<br>
...
<input type="text" class="form-control" name="income" id="amount" placeholder="Enter your amount" required >
<br>
...
$sql="SELECT * FROM room_expenses  WHERE User_ID='$id' and Status='Deposit'";
...
<button name="room_saving_delete" class="btn btn-danger"><i class="bi bi-trash3"></i>
</form>
